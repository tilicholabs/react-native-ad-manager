...
class BannerAdView extends ReactViewGroup implements AppEventListener, LifecycleEventListener {
    ...
    public void setSelectedCategory(String selectedCategory) {
        try {
            ...
            sendErrorEvent("Error found at ad manager when setSelectedCategory(): " + e.getMessage() + "!");
        }
    }

    public void setAdAtIndex(String adAtIndex) {
        try {
            this.adAtIndex = adAtIndex;
        } catch (Exception e) {
            sendErrorEvent("Error found at ad manager when setAdAtIndex(): "+e.getMessage()+"!");
        }
    }
